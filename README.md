...
* Delimitar los datos (guiones/paréntesis/mayúsculas/minusculas para que la data venga mas limpia): por ejemplo, en los campos de cédula y teléfono, que o todos vengan con guiones o no permita colocarlos para que al momento de descargar la data venga uniforme. Igual con lo nombres.
()Que los datos esten unificados, que  los numeros de tlf tengan los guiones donde van y al poner el nombre, cuando le des espacio, la siguiente letra se ponga en mayuscula. 

* Poner rep dom primero y la nacionalidad en listado: en el dropdown de países RD en preseleccionado.
(LISTO)Poner en nacionalidad el pais. 

* Ciudad va antes de sector, pero colocarlo según como está en el ayuntamiento
() Buscar 

* Dirección junto y lo que no es nacionalidad
(LISTO) Calle - Edificio - Número - Interior va despues de lugar de nacimiento 

* Estados civiles: soltero/casados y quitar los demás
(LISTO)

* Profesión dropdown (ver si a nivel de cumplimiento): tengo que pasarte el listado de las profesiones
()

*FATCA:
* Poner un dropdown de los países
...
* Origen del destino de los fondos dropdown: te paso el listado en una imagen. Ej.: Salario, Herencia, Venta de inmueble
...
* Riesgo de productos *Perfil de riesgo del inversionista* quitar ese título y dejar el párrafo.
(LISTO) Quitarle el titulo al legal info "Riesgo de productos y servicios"

* Nivel académico: poner en orden académico: primaria, bachiller, curso técnico, etc...
(LISTO)
...
* Requisitos de documentos colocarlo arriba: las especificaciones de los adjuntos (el peso y formato) que vaya antes de adjuntar para que el cliente lo tome en cuenta.
(LISTO VERIFICAR SI ERA ESO)
